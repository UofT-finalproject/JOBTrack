...
const CareerServicesItem = () => (
  <Container>
    ...
    <Image src={careerpic} />Find Helpful Links From Career Services Below:
      ...
      <Item.Group relaxed>
        <Item>
        <Icon name='searchengin' size='huge' color='grey'style={{ marginRight: 10, marginBottom: 10}}/>
          <Item.Content>
            <Item.Header>
              <a
        ...
        <Item>
        <Icon name='slideshare' size='huge' color='grey'style={{ marginRight: 10, marginBottom: 10}} />
        ...
        <Item>
        <Icon name='book' size='huge' color='grey'style={{ marginRight: 10, marginBottom: 10}} />
        ...
        <Item>
        <Icon name='clipboard list' size='huge' color='grey'style={{ marginRight: 10, marginBottom: 10}} />
        ...
        <Item>
        <Icon name='youtube square' size='huge' color='grey'style={{ marginRight: 10, marginBottom: 10}} />
          <Item.Content>
            <Item.Header>          <a
